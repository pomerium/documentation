...
The Pomerium project has strict rules for AI usage:
...
- **Bad AI drivers will be banned.** People who produce bad contributions that are clearly AI (slop) will be blocked from future contributions.
- **Security issues must be reproducible.** A report that is speculative, excessively verbose, missing reproduction detail, or not clearly reviewed by a human may be closed without a detailed response.

These rules apply only to outside contributions to Pomerium. Maintainers are exempt from these rules and may use AI tools at their discretion; they've proven themselves trustworthy to apply good judgment.

## There are humans here

Pomerium is maintained by humans.
...
**Our reason for the strict AI policy is not due to an anti-AI stance.** This section exists to be transparent about the project's usage of AI for people who may disagree with it, and to address the misconception that this policy is anti-AI in nature.
