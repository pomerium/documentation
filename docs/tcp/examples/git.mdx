...
When hosting a self-hosted Git server like [GitLab](/guides/gitlab) behind Pomerium, you can protect desktop client access to the source code with the same identity-aware access as the web interface using an encrypted TCP tunnel.

:::tip
This example assumes you've already [created a TCP route](/tcp/readme#configure-routes) for this service.
:::
...
:::tip
If you've already defined an SSH configuration for all domains managed by Pomerium as described in our [SSH Example](/tcp/examples/ssh#always-tunnel-through-pomerium), you can skip the first step above and define your new remote with the Git server's domain name.
:::

## More Resources

- [Git Documentation](https://git-scm.com/doc)
- [Secure GitLab with Pomerium](/guides/gitlab)