...
- **Enterprise Administrators** can review the [Devices](/enterprise/reference/manage#devices) reference material to create pre-approved enrollment links for users.
