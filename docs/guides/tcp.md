...
* The [Pomerium Client](/releases.md#pomerium-cli) installed
...
To connect to your service, ensure [`pomerium-cli`](/releases.md#pomerium-cli) is in your `$PATH` and run the `tcp` command, specifying the service you wish to reach.
