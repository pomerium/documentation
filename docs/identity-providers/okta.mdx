...
This page covers configuring Okta to communicate with Pomerium as an [IdP](/overview/glossary#identity-provider). It assumes you have already [installed Pomerium][pomerium-install] before you begin.
