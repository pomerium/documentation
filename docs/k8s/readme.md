...
2. A [policy route](/reference/policy/policy) is created for the API server and [configured](/reference/routes/kubernetes-service-account-token) to use the service account token
