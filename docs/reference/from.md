...
Specifying `tcp+https` for the scheme enables [TCP proxying](/docs/tcp/readme) support for the route. You may map more than one port through the same hostname by specifying a different `:port` in the URL.
