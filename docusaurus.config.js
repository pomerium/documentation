...
const config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'old_version',
      content: 'You\'re viewing the <b>Pomerium v0.XX</b> docs website. This documentation is outdated. To view the latest documentation, go to <a href="https://pomerium.com/docs">https://pomerium.com/docs</a>.',
