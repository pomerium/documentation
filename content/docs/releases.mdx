...
- [Pomerium Core](/docs/core): An open-source reverse proxy that all the other Pomerium components are built on top of
- [Pomerium Enterprise](/docs/enterprise): The Enterprise Console built on top of Pomerium Core
...
- [Upgrading](/docs/core/upgrading)
- [Changelog](/docs/core/changelog)

**Pomerium Enterprise:**

- [Upgrading](/docs/enterprise/upgrading)
- [Changelog](/docs/enterprise/changelog)
