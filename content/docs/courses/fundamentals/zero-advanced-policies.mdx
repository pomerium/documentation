...
**Get the value of the `email` claim**
    ...
    This action displays user information in a platintext, JSON format pulled from claims in the user's JWT.
...
Go to [**Advanced Routes**](/docs/courses/fundamentals/zero-advanced-routes).
