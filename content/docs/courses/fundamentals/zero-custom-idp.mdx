...
You can integrate Pomerium with any identity provider (IdP) that supports the OAuth2.0 and OIDC protocols. For the purposes of this guide, we will use [GitHub](/docs/identity-provides/github) as the IdP (the configuration is simpler than other IdPs).
...
[ Placeholder for GIF showing the integration in action ]
