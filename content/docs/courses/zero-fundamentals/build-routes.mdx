...
This guide assumes you've completed the [**Pomerium Zero Quickstart**](/docs/quickstart).
...
![A diagram demonstrating how Pomerium proxies requests with the From and To URLs in a route block](./img/routes/from-and-to-urls.png)
