...
<iframe
  src="https://www.loom.com/embed/b71d47acb9b04cdb996184b8b08f9986?sid=03569186-e229-43a6-a609-1141fc0bd879"
  frameborder="0"
  width="100%"
  height="500"
...
- [**Build Policies**](/docs/courses/zero-fundamentals/build-policies)
...
![Diagram depicting the JWT flow for single sign on with Pomerium](./img/sso/jwt-flow.svg)
...
![Viewing the user's profile information synced from the JWT in Grafana](./img/sso/pz-courses-jwt-synced.png)
...
services:
  pomerium:
    image: cr.pomerium.com/pomerium/pomerium:v0.25.1
    ports:
      - 443:443
    restart: always
    environment:
