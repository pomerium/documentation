...
# Pomerium header
curl -H 'Authorization: Pomerium a.real.jwt' "https://$ANY_POMERIUM_PROXIED_SERVICE"
# GET parameter
curl "https://$ANY_POMERIUM_PROXIED_SERVICE/?pomerium_session=$JWT"
# Cookie
curl -H "Cookie: _pomerium=$JWT" "https://$ANY_POMERIUM_PROXIED_SERVICE"
# Basic auth
curl -u "pomerium:$JWT" "https://$ANY_POMERIUM_PROXIED_SERVICE"
```
