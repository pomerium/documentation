---
title: Okta
description: Configure Okta as an identity provider for Pomerium with OIDC and directory sync.
lang: en-US
keywords: [okta oidc, identity provider, idp, context, context-aware]
