...
sidebar_label: 7. Custom Identity Provider
sidebar_position: 7
---

# Zero Fundamentals: Configure a Custom Identity Provider

So far, you've been using our [Hosted Authenticate service](/docs/capabilities/authentication), which provides a hosted authenticate service URL (`authenticate.pomerium.app`) and Pomerium's hosted identity provider to authenticate users.
...
- [**Build TCP Routes**](/docs/get-started/fundamentals/zero/zero-tcp-routes)
...
You can integrate Pomerium with any identity provider (IdP) that supports the OAuth2.0 and OIDC protocols. For the purposes of this guide, we will use [GitHub](/docs/integrations/user-identity/github) as the IdP (the configuration is simpler than other IdPs).
...
- [Apple](/docs/integrations/user-identity/apple)
- [Auth0](/docs/integrations/user-identity/auth0)
- [Microsoft Entra ID (Azure AD)](/docs/integrations/user-identity/azure)
- [Cognito](/docs/integrations/user-identity/cognito)
- [GitHub](/docs/integrations/user-identity/github)
- [GitLab](/docs/integrations/user-identity/gitlab)
- [Google](/docs/integrations/user-identity/google)
- [Okta](/docs/integrations/user-identity/okta)
- [OneLogin](/docs/integrations/user-identity/one-login)
- [Ping Identity](/docs/integrations/user-identity/ping)
- [Identity Providers](/docs/integrations/user-identity/identity-providers) for other OIDC-compatible providers
