...
- [**Configure port 443 to allow inbound access**](/docs/troubleshooting)
...
You need the Pomerium CLI client to connect to services like **SSH** over a TCP connection. See the [**Pomerium CLI**](/docs/capabilities/non-http/client) page for installation instructions.
