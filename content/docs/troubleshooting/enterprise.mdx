...
This document shows you how to troubleshoot various issues in Pomerium Enterprise.
...
![Check Last Error to see if an error interrupted directory sync](./img/enterprise/polling-delay-settings/last-error-and-request-duration.gif)
...
![Find the IdP Polling Delays settings in the Console](./img/enterprise/polling-delay-settings/adjust-polling-delay-settings.gif)
