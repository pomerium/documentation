...
Pomerium is an open source identity-aware proxy built around the principles of [BeyondCorp](https://research.google/pubs/pub43231) and zero trust. It secures your internal applications by continually verifying a user's identity, device state, and context before granting access. Unlike VPN-based approaches, Pomerium provides a scalable, modern alternative that centralizes access policy without requiring additional client software.
