...
If you get a self-signed certificate warning, see [Handle Self-Signed Certificate Warning](/docs/troubleshooting/miscellaneous#handle-self-signed-certificate-warning) to bypass it.
