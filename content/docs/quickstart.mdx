...
Pomerium will deploy and run in a special "Zero-managed" mode. In Zero-managed mode, Pomerium connects to the Pomerium Zero cloud service. The Zero cloud hosts the Zero Console, a remote control plane where you can manage your deployments and configuration.
