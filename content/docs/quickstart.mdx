...
<details>
  <summary><b>Handle self-signed certificate warning</b></summary>
  <div>
  Adding certificates to your configuration is beyond the scope of this quickstart.
  <br/>
  ...
  <ol>
   ...
   <li>Select <b>Proceed to verify.localhost.pomerium.io (unsafe)</b></li>
  </ol>

  If you don't see an <b>Advanced</b> option:

  <ol>
   <li>Click anywhere in the window</li>
   <li>Type "thisisunsafe" (no spaces)</li>
   <li>Make sure <b>Reload</b> is selected</li>
   <li>Select <b>Enter</b></li>
  </ol>
