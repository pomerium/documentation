...
Run open-source Pomerium Core with Docker containers in **under 5 minutes**.
...
Because you didn't include a [signing key](/docs/reference/signing-key), identity verification will fail.
...
If you want to [try Enterprise](https://www.pomerium.com/enterprise-sales/), check out the [Enterprise with Docker quickstart](/docs/releases/enterprise/install/quickstart).

If you want to try connecting Pomerium with other services, see some of our [Guides](/docs/guides).

**Did you finish this quickstart guide?** We've love to hear what you think about it. Check out our [Community](https://www.pomerium.com/docs/community) page to get in touch.
