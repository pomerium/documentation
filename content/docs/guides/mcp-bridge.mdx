...
![Zero Console Settings MCP section with Allowed Client ID Domains vscode.dev and AS Metadata Domains mcp.linear.app](./img/mcp-bridge/settings-mcp.png)
...
![Route editor General tab for the Linear MCP route: Route Type MCP, To mcp.linear.app, with the policy attached](./img/mcp-bridge/route-linear-mcp-general.png)
...
![Route editor Advanced tab MCP panel: Server mode selected, Upstream OAuth2 Properties off, and Path set to /mcp](./img/mcp-bridge/route-advanced-mcp-panel.png)
...
![Policy editor General tab for Pomerium Team: a single Allow block with an AND condition matching Domain Is pomerium.com](./img/mcp-bridge/policy-pomerium-team.png)
...
![Zero Console Logging settings with Custom Logged Fields and mcp-method, mcp-tool, and mcp-tool-parameters checked](./img/mcp-bridge/settings-authorize-log-fields.png)
...
![MCP Inspector connection form with Transport Type Streamable HTTP and the route URL, ready to click Connect](./img/mcp-bridge/inspector-connect-form.png)
