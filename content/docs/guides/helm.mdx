...
sidebar_label: Helm
lang: en-US
keywords: [pomerium, identity access proxy, oidc, kubernetes, helm, reverse proxy, ingress controller]
---
...
:::warning
After re-evaluating the complexity required to both use and manage Helm for Pomerium, we've opted not to continue updating our Helm file. Instead we've created a simpler Deployment-based method, which you can read about on our [Kubernetes Quickstart](/docs/k8s/quickstart) page.
:::
