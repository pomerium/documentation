...
After re-evaluating the complexity required to both use and manage Helm for Pomerium, we've opted not to continue updating our Helm chart. Instead we've created a simpler deployment method, which you can read about on our [Kubernetes Quickstart](/docs/kubernetes/quickstart) page.
...
[ingress controller]: /docs/kubernetes/ingress.md
