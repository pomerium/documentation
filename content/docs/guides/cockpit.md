...
- Install Pomerium
  - [Binaries](/docs/pomerium-core/core) if installing Pomerium as a system-level service.
  - [Pomerium using Docker](/docs/quickstart) if installing Pomerium as a Docker container
  - [Install Pomerium using Kubernetes](/docs/deploying/k8s/quickstart) for Kubernetes environments.
