...
lang: en-US
image: ./img/grafana/grafana-profile.png
keywords: [pomerium, identity access proxy, grafana, sso, oidc, jwt, authentication, authorization]
...
<iframe
  title="Video walkthrough: secure Grafana with Pomerium SSO"
  width="100%"
  height="500"
