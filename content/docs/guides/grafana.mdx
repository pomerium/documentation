...
Add the Grafana configuration below to the Docker Compose file running Pomerium Zero. The Grafana environment variables tell Grafana to accept JWTs from the incoming request and what claims to look for.
...
Now, in your Zero Console apply your changeset. Then, run the following command to start Docker:
