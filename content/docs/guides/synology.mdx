...
This guide is hardware-specific: it depends on Synology DSM, its built-in nginx reverse proxy, the DSM certificate store, and a physical router port-forward. Test it on a real Synology DSM device.
