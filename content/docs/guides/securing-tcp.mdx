...
- The [Pomerium Client](/docs/deploy/core/clients/pomerium-cli) installed
...
To connect to your service, ensure [`pomerium-cli`](/docs/deploy/core/clients/pomerium-cli) is in your `$PATH` and run the `tcp` command, specifying the service you wish to reach.
