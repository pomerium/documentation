...
- The [Pomerium Client](@site/content/docs/releases/pomerium-cli.mdx) installed
...
To connect to your service, ensure [`pomerium-cli`](@site/content/docs/releases/pomerium-cli.mdx) is in your `$PATH` and run the `tcp` command, specifying the service you wish to reach.
