...
- The [Pomerium Client](@site/docs/releases/pomerium-cli) installed
...
To connect to your service, ensure [`pomerium-cli`](@site/docs/releases/pomerium-cli) is in your `$PATH` and run the `tcp` command, specifying the service you wish to reach.
