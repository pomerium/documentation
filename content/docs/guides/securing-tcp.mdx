...
- The [Pomerium Client](/docs/pomerium-core/pomerium-cli) installed
...
To connect to your service, ensure [`pomerium-cli`](/docs/pomerium-core/pomerium-cli) is in your `$PATH` and run the `tcp` command, specifying the service you wish to reach.
