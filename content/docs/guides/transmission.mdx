...
This is an auth + upstream smoke test: Pomerium gates the route and, once you're signed in, proxies through to Transmission's web UI and RPC interface. Transmission's own RPC authentication is a separate layer; configure it (or leave it disabled, as below) according to your trust boundary.
