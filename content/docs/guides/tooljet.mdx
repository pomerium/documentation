...
ToolJet provides its own RBAC-based [permissions](https://docs.tooljet.com/docs/org-management/permissions) and several [user authentication](https://docs.tooljet.com/docs/user-authentication/sso/saml/) flows, so proxied requests will require users to sign in twice.
