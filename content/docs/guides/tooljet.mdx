...
ToolJet supports SSO through GitHub and Google for free.

This guide will use GitHub as the identity provider (IdP) to authenticate users against Pomerium before granting access to a ToolJet workspace.
...
- [GitHub](/docs/identity-providers/github) as an IdP
...
Keep the default values for the other environment variables.
...
To enable SSO with GitHub:

1. In your ToolJet dashboard, select **Workplace settings**
2. Select **SSO**
3. Select **GitHub**
4. Enter your **Client ID** and **Client Secret**
5. Select the toggle button to enable GitHub SSO
6. Select **Save**

![Enable GitHub SSO](./img/tooljet/tooljet-soo.png)

Disable password login:

1. Under the **SSO** sidebar, select **Password Login**
2. Select the toggle button to disable password login
3. Select **Save**
