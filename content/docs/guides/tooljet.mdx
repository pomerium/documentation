...
The Docker Compose configuration in the Enterprise portion of this guide uses same implementation as the [Enterprise Quickstart](/docs/releases/enterprise/install/quickstart).
...
Make sure your `console-config.yaml` file contains your `administrators` and your `license_key`:
