...
:::danger Before You Proceed Since this guide was written, Pomerium has developed into a first-class proxy service, and provides an integrated [Ingress Controller](/docs/k8s/ingress) for Kubernetes.
