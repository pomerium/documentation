---
# cSpell:ignore vals secretref gcpsecrets signin

title: Securing Cloud Run endpoints
sidebar_label: Cloud Run
lang: en-US
keywords:
  [pomerium, identity access proxy, gcp, google, iap, serverless, cloudrun]
...
import CloudRunConfig from '/content/examples/cloudrun/config.yaml.md';
import PolicyTemplate from '/content/examples/cloudrun/policy.template.yaml.md';
import Zonefile from '/content/examples/cloudrun/zonefile.txt.md';
import DeployScript from '/content/examples/cloudrun/deploy.sh.md';
...
See [getting user's identity](/docs/capabilities/getting-users-identity) for more details on using this header.
