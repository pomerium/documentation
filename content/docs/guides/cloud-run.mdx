...
The older standalone Cloud Run deployment guide targeted Pomerium v0.17 and a `-cloudrun` container image that is no longer maintained. This page replaces it with the current approach.
