...
Unlike the other components in this guide, `pomerium/verify` publishes only rolling tags (`latest`, `main`, `sha-*`), so it is intentionally not version-pinned. It is a throwaway smoke-test app, not part of your real workload set.
