...
- The attached policy authorizes users with a matching email address to access TiddlyWiki. Pomerium will forward these email addresses to TiddlyWiki as unsigned identity headers.
