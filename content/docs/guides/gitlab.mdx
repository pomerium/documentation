...
title: GitLab
lang: en-US
keywords: [pomerium, identity access proxy, gitlab, gitlab-ee, docker, authentication, authorization, self-hosted]
...
<video controls  muted={true} width="100%"><source src="/gitlab-login.webm" type="video/webm"/>
