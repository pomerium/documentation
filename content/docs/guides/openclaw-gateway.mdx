...
4. As a user your policy excludes, open `https://openclaw.yourdomain.com`. Pomerium should send you to sign in and then deny access, so you never reach the gateway dashboard.
