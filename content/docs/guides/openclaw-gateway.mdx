...
2. Sign in as a user your policy allows. After login Pomerium proxies you to the OpenClaw control UI:

   ![The OpenClaw gateway dashboard reached through Pomerium after signing in](./img/openclaw-gateway/openclaw-gateway.png)
