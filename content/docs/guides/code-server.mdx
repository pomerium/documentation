...
3. In the **From** field, enter a publicly accessible route (e.g. `code.localhost.pomerium.io`)
4. In the **To** field, enter the local hostname for the server running code-server
5. Select **Timeouts**
6. Select **Allow Websockets**
7. Under Policies, select **Allow anybody**
8. Select **Pass identity headers to upstream applications**
9. Save your route
