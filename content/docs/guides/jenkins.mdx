...
This guide also uses Pomerium's [**Hosted Authenticate**](/docs/capabilities/hosted-authenticate-service) service. If you'd like to use a custom identity provider, see **Custom IdP**.
