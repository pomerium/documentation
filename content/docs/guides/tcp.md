...
* The [Pomerium Client](/docs/overview/releases#pomerium-cli) installed
...
To connect to your service, ensure [`pomerium-cli`](/docs/overview/releases#pomerium-cli) is in your `$PATH` and run the `tcp` command, specifying the service you wish to reach.
