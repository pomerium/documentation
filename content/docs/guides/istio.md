...
In our [Mutual Authentication section on Sidecars](/docs/topics/mutual-auth#mutual-authentication-with-a-sidecar), we detail how a single service can offload authN and authz to a sidecar service. In a service mesh, each service in an internal network is deployed with a sidecar, and the controller configures them to provide mutual authentication with each other:
...
See the [Legend](/docs/topics/mutual-auth#legend) on our Mutual Authentication page for details on our graphing style.
:::
...
1. When [defining a test service](/docs/k8s/helm#define-a-test-service), you should now see two containers for the service pod:
...
1. Follow the instructions in the terminal output to log in as the admin user. Follow the [Add Users to Grafana](/docs/guides/grafana#add-users-to-grafana) section of our Grafana guide to add a user that can be identified by the Pomerium JWT.
...
[authN]: /docs/overview/glossary.md#authentication
[authZ]: /docs/overview/glossary.md#authorization
[Istio]: https://istio.io/latest/
[istio]: https://github.com/istio/istio
[certmanager]: https://github.com/jetstack/cert-manager
[grafana]: https://github.com/grafana/grafana
[grafana-guide]: /docs/guides/grafana
[east-west traffic]: /docs/overview/glossary.md#east-west-traffic
