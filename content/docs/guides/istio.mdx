...
1. When [defining a test service](/docs/kubernetes/quickstart#test-service), you should now see two containers for the service pod:
...
[pomerium ingress controller]: /docs/kubernetes/ingress.md
