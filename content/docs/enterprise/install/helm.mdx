...
Helm installation is deprecated and is not recommended for new deployments. Please use [manifests-based installation](/docs/kubernetes/enterprise/kustomize) that provides a simpler installation experience.
