...
- Integrate with FleetDM to support policy enforcement based on device state. With this integration you can ensure that only trusted devices are allowed to access certain routes.
