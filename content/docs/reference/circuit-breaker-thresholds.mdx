...
- Max Connections: The maximum number of connections that Pomerium will establish to all hosts in an upstream cluster. Default is `1024`.
...
- Max Requests: The maximum number of requests that can be outstanding to all hosts in a cluster at any given time. Default is `1024`.
- Max Retries: The maximum number of retries that can be outstanding to all hosts in a cluster at any given time. Default is `3`.
