...
As of v0.25, we've removed the **Cookie Secure** setting in Pomerium Core, the Enterprise Console, and the Ingress Controller (in the Console, this setting was called **HTTPS only**). Now, this setting will always bet set to `true`.
...
As of v0.25, we've removed the **Cookie Secure** setting in Pomerium Core.
...
As of v0.25, we've removed the **Cookie Secure** parameter setting from the Kubernetes global CRD.
