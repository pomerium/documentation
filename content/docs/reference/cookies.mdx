...
| **[Parameter name](/docs/k8s/reference#cookie)** | **Type** | **Default** |
| :----------------------------------------------- | :------- | :---------- |
...
See Kubernetes [bootstrap secrets](/docs/k8s/configure#bootstrap-secrets) for more information.
...
| **[Parameter name](/docs/k8s/reference#cookie)** | **Type** | **Usage** | **Default** |
| :-- | :-- | :-- | :-- |
...
| **[Parameter name](/docs/k8s/reference#cookie)** | **Type** | **Usage** | **Default** | **Options** |
| :-- | :-- | :-- | :-- | :-- |
...
See Kubernetes [Secrets reference](/docs/k8s/reference#spec) for more information.
