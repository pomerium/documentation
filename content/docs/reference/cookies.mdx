...
As of v0.25.0, we have deprecated the **Cookie Secure** setting in Pomerium Core, the Enterprise Console, and the Ingress Controller and will remove it in **v0.26.0**. It will be enabled by default going forward.
...
As of **v0.25.0**, we've deprecated the **Cookie Secure** setting in Pomerium Core and will remove it in **v0.26.0**. Now, this setting will be enabled by default.

</TabItem>
<TabItem value="Enterprise" label="Enterprise">

As of **v0.25.0**, we've removed the **Cookie Secure** setting from the Enterprise Console (in the Console, this setting was called **HTTPS only**). Now, this setting will be enabled by default.

</TabItem>
<TabItem value="Kubernetes" label="Kubernetes">

As of **v0.25.0**, we've deprecated the **Cookie Secure** parameter and will remove it in **v0.26.0**. Now, this setting will be enabled by default.
