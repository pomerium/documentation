...
We've removed the **Cookie Secure** setting in Pomerium Core, the Enterprise Console, and the Ingress Controller. Now, this setting will always be enabled by default.
...
We've removed the **Cookie Secure** setting in Pomerium Core. Now, this setting will always be enabled by default.
...
We've removed the **Cookie Secure** parameter from the Kubernetes global CRD. Now, this setting will always be enabled by default.
