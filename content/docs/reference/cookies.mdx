...
## Cookie HTTP Only (Deprecated) {#cookie-http-only}

:::warning Deprecated

The `cookie_http_only` setting is deprecated and will be removed in a future version. The HttpOnly flag will be permanently enabled for security reasons, as disabling it exposes session cookies to JavaScript access and potential XSS attacks.
...
Setting `cookie_http_only: false` is strongly discouraged and this option is deprecated. It will be removed in a future version.

:::

```yaml
# DEPRECATED - DO NOT USE
# cookie_http_only: false  # This exposes cookies to JavaScript attacks
```
...
The Cookie HTTP Only setting is deprecated. The **Javascript Security** toggle will be removed in a future version, and cookies will always have the HttpOnly flag enabled for security.
...
- **Checkmark** sets `cookie_http_only` to `true` (recommended)
- **Empty** sets `cookie_http_only` to `false` (deprecated - security risk)
...
Setting `httpOnly: false` is strongly discouraged and this option is deprecated. It will be removed in a future version.
...
# DEPRECATED - DO NOT USE
# cookie:
#   httpOnly: false  # This exposes cookies to JavaScript attacks
```
