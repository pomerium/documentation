...
<EnterpriseConfiguration name="allow_websockets" resource="route">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="allow_spdy" resource="route">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="timeout" resource="route">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="idle_timeout" resource="route">
