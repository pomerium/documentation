...
| **Parameter name**    | **Type**      | **Usage**    |
| :-------------------- | :------------ | :----------- |
| `set_request_headers` | Map of String | **optional** |
...
resource "pomerium_route" "verify_route" {
  ...
  to           = ["https://verify.pomerium.com"]
  set_request_headers = {"Pomerium-jwt": "$${pomerium.jwt}", "X-Your-favorite-authenticating-Proxy": "Pomerium"}
}
```
...
| **YAML**/**JSON** setting | **Type**      | **Usage**    |
| :------------------------ | :------------ | :----------- |
| `remove_request_headers`  | Set of String | **optional** |
...
resource "pomerium_route" "verify_route" {
  ...
  from         = "https://verify.localhost.pomerium.io"
  to           = ["https://verify.pomerium.com"]
  remove_request_headers = ["X-Email", "X-User"]
}
```
...
| **YAML**/**JSON** setting | **Type**      | **Usage**    |
| :------------------------ | :------------ | :----------- |
| `set_response_headers`    | Map of String | **optional** |
...
| **YAML**/**JSON** setting  | **Type**      | **Usage**    |
| :------------------------- | :------------ | :----------- |
| `rewrite_response_headers` | Map of String | **optional** |
...
resource "pomerium_route" "verify_route" {
  ...
  from         = "https://verify.localhost.pomerium.io"
  to           = ["https://verify.pomerium.com"]
  rewrite_response_headers = {"X-Test": "X-New-Value"}
}
```
