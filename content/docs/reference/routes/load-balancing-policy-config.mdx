...
See Kubernetes [Ingress](/docs/k8s/ingress#load-balancing) for more information

</TabItem>
</Tabs>

See [Load Balancing](/docs/capabilities/load-balancing) for example [configurations](/docs/capabilities/load-balancing#load-balancing-method)
