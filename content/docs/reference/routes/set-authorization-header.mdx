...
As of v0.24.0, `set_authorization_header` has been **deprecated** in favor of [`set_request_headers`](/docs/reference/routes/set-request-headers) and will be removed in future versions.
