...
The dynamic values enable you to pass ID and Access tokens in your requests.

See the configuraiton options below for examples of static and dynamic headers applied to a route.
