...
| **Parameter name** | **Type** | **Usage** | **Schemes** |
| :-- | :-- | :-- | :-- |
| `to` | Set of String | **optional** | `http`, `https`, `h2c`, `tcp`, `udp` |

### Examples

```hcl
resource "pomerium_route" "example_route" {
  name         = "example-route"
  namespace_id = pomerium_namespace.test_namespace.id
  from         = "https://example.com"
  to           = ["https://a.example.com", "https://b.example.com", "https://c.example.com"]
}
```
