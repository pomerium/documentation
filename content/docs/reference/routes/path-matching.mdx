...
<EnterpriseConfiguration name="path" resource="route">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="prefix" resource="route">
...
See Kubernetes [Ingress](/docs/deploy/k8s/ingress#set-ingress-annotations) for more information
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="regex" resource="route">
