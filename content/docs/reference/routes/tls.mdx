...
<EnterpriseConfiguration name="tls_client_key_pair_id" resource="route">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="tls_custom_ca_key_pair_id" resource="route">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="tls_downstream_client_ca" resource="route" via={['ui']}>
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="tls_downstream_server_name" resource="route">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="tls_skip_verify" resource="route">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="tls_upstream_allow_renegotiation" resource="route">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="tls_upstream_server_name" resource="route">
