...
**Public Access** allows all requests to a given route and bypasses authentication and authorization. If you enable this setting, no other policy should be provided for the route.
