...
<EnterpriseConfiguration name="timeout_read" resource="settings">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="timeout_write" resource="settings">
...
<TabItem value="Enterprise" label="Enterprise">
<EnterpriseConfiguration name="timeout_idle" resource="settings">
