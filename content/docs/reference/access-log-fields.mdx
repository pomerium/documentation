...
import CoreConfigureTable from "../../../src/components/CoreConfigureTable";
import KubernetesConfigureTable from "../../../src/components/KubernetesConfigureTable";
import TerraformConfigureTable from "../../../src/components/TerraformConfigureTable";
...
<CoreConfigureTable
  ...
  defaultValue={
    <>
      See <a href="#access-fields-and-defaults">Access Fields and Defaults</a>
    </>
  }
/>
...
<TerraformConfigureTable
  ...
  supportedProducts={["core", "enterprise"]}
/>
...
## Access log fields and defaults {#access-fields-and-defaults}
