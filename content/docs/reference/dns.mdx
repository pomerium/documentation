...
| :-- | :-- | :-- | :-- |
| `dns_failure_refresh_rate` | `DNS_FAILURE_REFRESH_RATE` | `string` ([Go Duration](https://golang.org/pkg/time/#Duration.String) formatting) |  |
...
| **Config file keys** | **Environment variables** | **Type** | **Default** |
| :-- | :-- | :-- | :-- |
| `dns_refresh_rate` | `DNS_REFRESH_RATE` | `string` ([Go Duration](https://golang.org/pkg/time/#Duration.String) formatting) |  |
...
| **Config file keys**  | **Environment variables** | **Type**  | **Default** |
| :-------------------- | :------------------------ | :-------- | :---------- |
| `dns_udp_max_queries` | `DNS_UDP_MAX_QUERIES`     | `integer` |             |
