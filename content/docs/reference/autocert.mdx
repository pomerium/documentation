...
The suite of Autocert settings listed below are only supported in [Pomerium Core](/docs/core) configurations. Here's what you should know about Autocert support across other Pomerium products:
