...
- Pomerium Zero users should note that Pomerium automatically manages certificates for [starter domains](/docs/manage/clusters#starter-domain) and [custom domains](/docs/capabilities/custom-domains).
