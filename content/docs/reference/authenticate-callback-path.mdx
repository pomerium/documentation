...
If you want to run Pomerium with a self-hosted authenticate service, you must include an [**identity provider**](/docs/integrations/user-identity/identity-providers) and [**authenticate service URL**](/docs/reference/service-urls#authenticate-service-url) in your configuration.
