---
# cSpell:ignore keycloak, mykeycloak, myclient
id: oidc
title: OIDC
...
Because this example secures Pomerium's Verify app, you should add a signing key so Pomerium can sign the Pomerium JWT.
