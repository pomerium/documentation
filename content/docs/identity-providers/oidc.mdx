...
1. In **Web Origins**, enter `https://authenticate.localhost.pomerium.io`
  ![Add access settings](./img/oidc/keycloak-access-settings.png)
1. Under **Capabilities config**, turn on **Client authentication**
  ![Turn on client authentication](./img/oidc/keycloak-capability-config.png)
...
1. Copy the **Client secret**
  ![Get client secret](./img/oidc/keycloak-client-credentials.png)
