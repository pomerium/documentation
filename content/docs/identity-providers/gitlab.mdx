...
title: GitLab
lang: en-US
keywords: [gitlab, oidc, openid connect, identity provider, idp]pagination_prev: null
...
Unforunately, Gitlab does not support OpenID Connect, and does not support custom identity (`id_token`) group claims.
