...
title: GitHub
lang: en-US
# keywords: [github, oauth2, provider, identity provider, idp]pagination_prev: null
...
:::caution The [GitHub API] does not support [OpenID Connect], just [OAuth 2.0]. For this reason, it was challenging to implement revocation of a user's **Access Token** (a string representing the granted permissions) when they sign out from Pomerium's user info endpoint. :::
