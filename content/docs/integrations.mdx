...
Pomerium supports Classless Inter-Domain Routing (CIDR) indexing to improve database performance. This is useful if you're importing a list of records containing IP ranges.
