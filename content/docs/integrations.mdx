...
This article describes a use case only available to [Pomerium Enterprise](/docs/enterprise) customers.
...
For data sources using mTLS, you can select a [client certificate](/docs/guides/certificates) (added under **Manage** → **Certificates**) to provide to the data source.
