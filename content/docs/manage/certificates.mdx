...
![Certificate wildcard domain](./certificates/certificate-wildcard-domain.png)
...
[principles]: /docs/internals/zero-trust.md#history
[zero trust]: /docs/internals/zero-trust.md#zero-trust
