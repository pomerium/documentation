...
- [Wildcard From Routes](/docs/reference/routes/from#wildcard-from-routes) support allows you to define multiple near-identical external `from` routes that point to the same internal `to` route.
