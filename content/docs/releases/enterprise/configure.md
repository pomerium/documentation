...
| <a className="entRef-anchor" id="database-encryption-key-file">#</a><a href='#database-encryption-key-file'>database-encryption-key-file</a> | Loads `database-encryption-key` secret from a file. Setting this option from a file does not require base64 encoding. | none |
| <a className="entRef-anchor" id="database-encryption-key-raw-file">#</a><a href='#database-encryption-key-raw-file'>database-encryption-key-raw-file</a> | Loads `database-encryption-key` secret from a raw file. Setting this option from a file does not require base64 encoding. | none |
...
| <a className="entRef-anchor" id="shared-secret-file">#</a><a href='#shared-secret-file'>shared-secret-file</a> | Loads `shared-secret` from a file. Setting this option from a file does not require base64 encoding. | none |
| <a className="entRef-anchor" id="shared-secret-raw-file">#</a><a href='#shared-secret-raw-file'>shared-secret-raw-file</a> | Loads `shared-secret` from a raw file. Setting this option from a file does not require base64 encoding. | none |
...
| <a className="entRef-anchor" id="signing-key-file">#</a><a href='#signing-key-file'>signing-key-file</a> | Loads `signing-key` secret from a file. Setting this option from a file does not require base64 encoding. | none |
| <a className="entRef-anchor" id="signing-key-raw-file">#</a><a href='#signing-key-raw-file'>signing-key-raw-file</a> | Loads `signing-key` secret from a raw file. Setting this option from a file does not require base64 encoding. | none |
