...
Replace the `SIGNING_KEY` variable in your `pomerium` service:
...
Add the base64-encoded signing key to the `SIGNING_KEY` variable in your `docker-compose.yaml` file.
