...
Update the [identity provider](/docs/identity-providers) configuration variables with your own, and replace `user@example.com` with the email associated with your IdP.
