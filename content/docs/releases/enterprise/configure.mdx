...
The keys listed below can be applied in Pomerium Console's `config.yaml` file, or applied as environment variables.
...
<TabItem label="Configuration variables" value="Configuration variables">
