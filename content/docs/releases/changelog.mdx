...
- authenticate: fix authenticate\_internal\_service\_url for all in one [\#4003](https://github.com/pomerium/pomerium/pull/4003) (@wasaga)
...
- config: fix set\_response\_headers [\#4026](https://github.com/pomerium/pomerium/pull/4026) (@calebdoxsey)
...
- authenticate: don't require a session for sign\_out [\#4007](https://github.com/pomerium/pomerium/pull/4007) (@calebdoxsey)
...
- chore\(deps\): bump github.com/prometheus/client\_golang from 1.14.0 to 1.15.0 [\#4110](https://github.com/pomerium/pomerium/pull/4110) (@dependabot[bot])
