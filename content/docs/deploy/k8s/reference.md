    ...
    <tbody>
        ...
        <tr>
            <td>
                ...
                <p>
                    JWTClaimHeaders convert claims from the assertion token into HTTP headers and adds them into JWT assertion header. Please make sure to read <a href="/docs/capabilities/getting-users-identity"> Getting User Identity</a> guide.
                </p>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <p>
                    OTEL sets the <a href="/docs/reference/tracing">OpenTelemetry Tracing</a>.
                </p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                ...
                <p>
                    Storage defines persistent storage for sessions and other data. See <a href="/docs/internals/data-storage">Storage</a> for details. If no storage is specified, Pomerium would use a transient in-memory storage (not recommended for production).
                </p>
            </td>
        </tr>
        <tr>
