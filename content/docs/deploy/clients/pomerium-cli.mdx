...
Pomerium CLI is an optional command-line client that works as an authentication helper for tools like [kubectl](/docs/deploy/k8s/configure.md) and [TCP-based applications](/docs/capabilities/non-http/).
