...
- Please visit your IdP provider admin console to adjust group membership propagation to Claims.
  ...
  - [Cognito](/docs/integrations/cognito#getting-groups)
...
[Ping Identity](https://www.pingidentity.com/) is supported as a directory provider. See [the documentation](https://www.pomerium.com/docs/integrations/ping.html) for details.
