...
This release includes usability improvements with the AutoCert and Set Response Headers settings. It also includes changes to how Pomerium handles certain JWT claims (`exp` and `iss`), overlapping certificates, and other minor updates.
