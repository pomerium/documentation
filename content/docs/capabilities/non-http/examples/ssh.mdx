...
:::tip Port 443-restricted networks
If clients can only reach outbound port 443 or Pomerium sits behind an L4 edge, see [SSH over port 443 through an L4 edge](/docs/guides/ssh-tcp-l4-passthrough).
:::
