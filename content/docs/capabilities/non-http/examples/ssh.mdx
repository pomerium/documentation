...
:::tip TCP/443-restricted networks
If clients can only reach outbound TCP/443 or Pomerium sits behind an L4 edge, see [SSH over TCP/443 through an L4 edge](/docs/guides/ssh-tcp-l4-passthrough).
:::
