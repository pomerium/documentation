...
- [Security Considerations](#security-considerations) - Access control, token security, and session lifecycle
...
**Route Configuration (deny-based blocklist):**
...
Or, using a deny-based blocklist to prevent specific tools:
