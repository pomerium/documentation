...
### [Build an MCP Chat App](/docs/capabilities/mcp/build-mcp-chat-app)

Build a web app that captures the authenticated user's token and passes it to an LLM, enabling the LLM to call MCP servers on the user's behalf.
