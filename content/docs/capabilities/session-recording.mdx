...
See the [Session Recording Storage](/docs/capabilities/session-recording/storage) reference for full provider-specific URI parameters and credential setup.
...
For a complete guide on audit log correlation and integrity verification, see [Session Recording Auditing](/docs/capabilities/session-recording/auditing).
