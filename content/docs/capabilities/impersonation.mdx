...
User impersonation allows administrators to temporarily sign in to Pomerium as a user or group within an organization. The impersonating user is subject to the access and authorization policies of the impersonated user.
...
1. In the **Search Users** field, select the Service Account with the correct User id

![Add Service Account to a polic](./img/impersonation/add-service-account-to-policy.gif)

Now, you can add the policy to a route and only access it with the impersonated user's Service Account.
