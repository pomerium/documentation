---
sidebar_label: Admin Initiated Enrollment
lang: en-US
keywords:
  [
    pomerium,
...
1. From the **New Enrollment** modal:
   ...
   - define if the user can enroll any [trusted execution environment](/docs/internals/glossary#trusted-execution-environment), or restrict the user to [secure envlaves](/docs/internals/glossary#secure-enclave): ![Screenshot of the New Enrollment Modal](./img/webauthn/new-enrollment.png)
