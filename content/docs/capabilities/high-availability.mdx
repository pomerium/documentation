...
You can also define multiple domain names for Databroker or Authorize services with the [`databroker_service_url`](/docs/reference/databroker) and [`authorize_service_urls`](/docs/reference/service-urls#authorize-service-url) shared config keys.
