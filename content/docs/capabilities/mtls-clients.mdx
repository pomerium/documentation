...
- A working Pomerium instance. Complete the [Pomerium Core quickstart](/docs/get-started/quickstart) with Docker for a quick proof of concept to test with this guide.
