---
# cSpell:ignore commandline queryparam
...
This page describes how to obtain Pomerium access credentials programmatically via a web-based oauth2 style authorization flow. If you have ever used Google's [`gcloud`](https://cloud.google.com/sdk/gcloud) commandline app, the mechanism is very similar.
