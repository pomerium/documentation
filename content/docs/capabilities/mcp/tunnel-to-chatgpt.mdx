...
keywords: [MCP, model context protocol, ChatGPT, pom.run, SSH tunnel, local development]
---
...
- Pomerium authenticates and authorizes every request
...
Ask ChatGPT to call your app. For example: "@Echo Hi there!"
