...
**[Go to Blueprint: Build an MCP Chat App →](/docs/capabilities/mcp/build-mcp-chat-app)**
...
- [Build an MCP Chat App](/docs/capabilities/mcp/build-mcp-chat-app) - Token delegation to LLM APIs
