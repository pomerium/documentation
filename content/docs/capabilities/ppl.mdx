...
In the **Enterprise Console**, you can sync unique organizational data into your Console instance and use it as context in your authorization policies.

![Adding external data source to a policy](./img/ppl/record-policy.gif)

Get a free trial when you [**Upgrade to Enterprise**](/docs/deploy/enterprise) today.
