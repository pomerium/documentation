...
Below is an exhaustive list of PPL criteria. Entries marked with `*` denote criteria that are only available in the [Enterprise Console](/docs/deploy/enterprise) PPL builder.
...
\* Denotes criteria that are only available in the Enterprise Console PPL builder.
