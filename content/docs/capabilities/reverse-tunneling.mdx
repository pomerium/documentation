...
sidebar_position: 8
keywords: [pomerium, ssh, native ssh, tunnel, reverse tunnel, reachability, port forward]
---
...
<b>
  Dynamic port forwarding is enabled only when the client requests port `0` in the remote
  address.[^4]
</b>
