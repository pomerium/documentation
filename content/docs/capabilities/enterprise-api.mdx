...
1. Grant the service account the appropriate [role](/docs/concepts/namespacing#rbac-for-enterprise-console-users) on the Namespace(s) it will operate against.
