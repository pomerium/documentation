...
- **Pomerium JWT** using Structured Authentication (Kubernetes 1.30+)

<Tabs groupId="auth-type">
<TabItem value="impersonation" label="Impersonation Headers">
...
![Kubernetes Integration](./img/kubernetes/kubernetes-integration-jwt.svg)
